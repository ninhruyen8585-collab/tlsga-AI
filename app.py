...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Văn Ninh - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0364787988</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Văn Ninh - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0364787988</div>", unsafe_allow_html=True)
